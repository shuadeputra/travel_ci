    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item px-2">
            <a href="<?php echo base_url(); ?>about_us" class="nav-link active">About Us</a>
          </li>
          <li class="nav-item px-2">
            <a href="<?php echo base_url(); ?>tiket" class="nav-link active">Tiket</a>
          </li>
          <li class="nav-item px-2">
...
<!----- Header ------>
  ...
  <footer id="main-footer" class="bg-dark text-white mt-5 p-5">
    <div class="conatiner">
      <div class="row">
        <div class="col">
          <p class="lead text-center">Copyright 2018 &copy; </p>
        </div>
      </div>
    </div>
  </footer>
