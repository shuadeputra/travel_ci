            ...
            <div class="card-body">
               ...
               <input type="hidden" name="blog_id" value="<?php echo $data_blog->blog_id; ?>" />
                ...
                <div class="form-group">
                 ...
                 <label for="blog_foto">foto blog 500x500</label><br>
                ...
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="blog_dsc" class="form-control"><?php echo $data_blog->blog_dsc; ?></textarea>
                </div>
                
            <div class="form-group">
              <label for="title">Title Seo</label>
                  <input name="title_seo" id="title_seo" type="text" class="form-control" value="<?php echo $data_blog->title_seo; ?>">
                </div>
                
                <div class="form-group">
              <label for="title">Keyword Seo</label>
                  <input name="keyword_seo" id="keyword_seo" type="text" class="form-control" value="<?php echo $data_blog->keyword_seo; ?>">
                </div>
                
                <div class="form-group">
              <label for="title">Description Seo</label>
                  <input name="description_seo" id="description_seo" type="text" class="form-control" value="<?php echo $data_blog->description_seo; ?>">
                </div>
