          ...
          <form action="<?php echo base_url(); ?>posts_blog/addProductSubmit" method="post" enctype="multipart/form-data">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea id="editor1" name="blog_dsc" class="form-control"></textarea>
            </div>
              
              <div class="form-group">
              <label for="title">Title Seo</label>
                  <input name="title_seo" id="title_seo" type="text" class="form-control" value="">
                </div>
                
                <div class="form-group">
              <label for="title">Keyword Seo</label>
                  <input name="keyword_seo" id="keyword_seo" type="text" class="form-control" value="">
                </div>
                
                <div class="form-group">
              <label for="title">Description Seo</label>
                  <input name="description_seo" id="description_seo" type="text" class="form-control" value="">
                </div>
